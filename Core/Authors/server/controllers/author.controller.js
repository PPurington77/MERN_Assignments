const { createAuthor, getAllAuthors, getAuthorById, updateAuthorById, deleteAuthorById } = require('../services/author.service');
...
module.exports = { handleCreateAuthor, handleGetAllAuthors, handleGetAuthorById, handleUpdateAuthorById, handleDeleteAuthorById } ;