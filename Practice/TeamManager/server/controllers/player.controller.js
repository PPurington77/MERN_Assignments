const { createPlayer, getAllPlayers, getPlayerById, updatePlayerById, deletePlayerById } = require('../services/player.service');

const handleCreatePlayer = async (req, res) => {
    console.log("controller: handleCreatePlayer", req.body);
...
module.exports = { handleCreatePlayer, handleGetAllPlayers, handleGetPlayerById, handleUpdatePlayerById, handleDeletePlayerById };